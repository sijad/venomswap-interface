...
export const getTokenFallbackLogoURL = (currency: Currency) =>
  `https://dvwecb5klcqus.cloudfront.net/venomswap/tokens/${currency.symbol}.png`
...
export default function CurrencyLogo({
  ...
  if (currency === ETHER) {
    ...
    if (currency === HARMONY || currency === wrappedCurrency) {
      return <StyledEthereumLogo src={HarmonyLogo} size={size} style={style} />
    } else if (currency === BINANCE_COIN || currency === wrappedCurrency) {
