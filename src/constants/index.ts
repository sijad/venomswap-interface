...
export const ROUTER_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HARMONY_TESTNET]: '0x5c1eAeAacEF55d7A6fD144818a217003d0B3007F'
}
...
export const GOVERNANCE_TOKEN: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.HARMONY_TESTNET]: new Token(
    ...
    '0xd6C787d3E07725409D47783a1B8dfA0FAEC97b77',
    18,
    'VIPER',
    'Viper'
  )
...
export const MASTER_BREEDER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HARMONY_TESTNET]: '0xc4a978F58565a6e2ea5d23733d8FA1374fBaF86e'
}
...
export const PIT_BREEDER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HARMONY_TESTNET]: '0xEc8A3F60d0316Aa819eAcA970760fCEB5B5FED70'
}
...
export const PIT: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.HARMONY_TESTNET]: new Token(
    ChainId.HARMONY_TESTNET,
    '0x3Ebdb7CEe8d03F659d87a29efd97029EF474706F',
    18,
    'xVIPER',
    'ViperPit'
  )
